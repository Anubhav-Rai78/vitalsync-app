...
const SHOW_SPECIALTY_X_AXIS = false;
...
export default function AnalyticsReportsPage() {
  ...
  const [doctors, setDoctors] = useState<{ initials: string; name: string; specialty: string; visits: number; score: number; reviewCount: number }[]>([]);
