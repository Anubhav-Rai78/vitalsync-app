...
// Admin client — service_role key. ONLY ever import this inside
// server-only code that never ships to the client (Route Handlers,
// Edge Functions, scheduled jobs). Bypasses RLS — use with care.
